...
const Throne = document.querySelector('.get-btn9');
const Clash15 = document.querySelector('.get-btn10');
...
// Clash15
Clash15.addEventListener('click', async () => {
    ...
    try {
        ...
        // Случайный выбор параметра i1 из AWGr и AWGm
        const i1Options = [
        ...
        const i1rand = i1Options[Math.floor(Math.random() * i1Options.length)];
